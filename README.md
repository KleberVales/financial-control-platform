...
This repository contains all the backend and frontend (if applicable) project code. The goal is to provide a full-stack solution for managing finances simply and efficiently, using modern technologies
